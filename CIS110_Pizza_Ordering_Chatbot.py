...
if userName.lower() == "cherrie white":
...
while keepGoing.lower() == "y":
 ...
 while size.lower() not in ["small, medium,or large: "]:
    while len(size) == 0:
    ...
    while len(crustType) == 0:
      crustType=input("CrustType cannot be blank! Please enter crustType:")
    ...
    print(f" Your[quantity] [size] [flavor] pizza(s) with [crustType] crust costs $[total:, 74] ")
    if total == 50:
